...
import { useCommunityTrend } from "../api";

export function TrendChart() {
  const { data, isLoading, isError } = useCommunityTrend();
        ...
        {isLoading ? (
          ...
          <ResponsiveContainer width="100%" height={256}>
            <AreaChart data={rows} margin={{ left: -20 }}>
              <defs>
                <linearGradient id="analyticsKgSavedFill" x1="0" y1="0" x2="0" y2="1">
              ...
              />
              <Area type="monotone" dataKey="kgSaved" stroke="var(--color-primary)" fill="url(#analyticsKgSavedFill)" strokeWidth={2} />
            </AreaChart>
          </ResponsiveContainer>
        )}
      </CardContent>
