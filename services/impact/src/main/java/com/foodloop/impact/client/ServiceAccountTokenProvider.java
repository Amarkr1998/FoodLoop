 ...
 * Keycloak identity ({@code foodloop-impact}). Same implementation as
 * services/matching's and services/ai-orchestration's — duplicated rather
 * than shared per those classes' own Javadoc on why (backend-commons stays
 * free of anything beyond tenant/error/correlation infra, ADR-003).
 */
@Component
