package com.foodloop.tenant.config;
...
/**
 * Every endpoint here requires authentication — unlike identity, there's no
 * public "first contact" endpoint (creating an organization requires an
 * already-registered, already-authenticated user).
 */
@Configuration
@EnableWebSecurity
